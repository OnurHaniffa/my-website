...
{#if visible}
	<!-- Positioned bottom-left to avoid overlap with chatbot widget (bottom-right) -->
	<div class="fixed bottom-6 left-6 z-50 flex items-end gap-3">
		<!-- Tooltip -->
		{#if showTooltip}
			<div
		...
		>
			...
			<!-- Pulse ring -->
			<span class="absolute w-14 h-14 rounded-full bg-[#25D366]/40 animate-ping pointer-events-none"></span>
		</a>
	</div>
{/if}
