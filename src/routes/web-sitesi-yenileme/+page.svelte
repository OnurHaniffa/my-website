	...
	<Container class="relative pt-12 pb-12 lg:pt-20 lg:pb-20">
		<div class="max-w-4xl">
			<div class="hero-reveal space-y-5">
				<p class="text-xs uppercase tracking-[0.3em] text-muted-foreground font-medium">Web Sitesi Yenileme • Ücretsiz Denetim · Yeni projelere açık</p>
				...
				<div class="flex flex-wrap gap-4 pt-2">
					...
					<Button size="lg" variant="ghost" href="#fiyatlar" class="text-base px-7 py-3.5 rounded-md border border-border/60 hover:bg-foreground/5">Fiyatları Gör</Button>
				</div>
			</div>
