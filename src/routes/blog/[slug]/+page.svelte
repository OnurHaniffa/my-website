		...
		<div class="mt-16 relative overflow-hidden rounded-2xl border border-primary/20">
			...
			<div class="relative p-8 sm:p-10 text-center">
				...
				<div class="flex flex-wrap justify-center gap-3">
					<a href={`https://wa.me/905428324550?text=${encodeURIComponent(isEn ? 'Hello! I would like to learn more about your web design services.' : 'Merhaba! Web sitesi hakkında bilgi almak istiyorum.')}`} target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2.5 px-8 py-3 rounded-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold text-sm shadow-lg shadow-[#25D366]/30 transition-all duration-200">
					...
					<Button href={getLocalePath('/contact')} variant="outline" class="rounded-full px-8">
